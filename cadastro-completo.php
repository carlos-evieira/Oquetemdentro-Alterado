...
<div class="row">
            <div class="col-md-12 col-sm-10 text-center my-3 mb-5">
                <h1 class="display-4">Selecione os produtos aos quais é alérgico</h1>
            </div>
        </div>
...
<div class="row justify-content-center mb-5">
    <div class="col-sm-12 col-lg-3">
            <div class="form-check col-sm-12 col-lg-3">
    ...
    <div class="col-sm-12 col-lg-3">
            ...
            <div class="form-check col-sm-12 col-lg-7">
